    ...
    <a-row :gutter="24">
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-one" @click="sendTitle('销售额', 'sale')">
          <div class="card-title">
            <a-space :size="8">
              <svg-icon icon="sale" :size="20" />总销售额
            </a-space>
          </div>
          <div class="all-count">
            ¥
            <count-to :startVal="0" :endVal="data.totalMoney" :duration="2200" />
          ...
          <div class="card-info relative">
            <div class="abs-bottom">
              <div style="margin-right:20px" class="inline-block">
                日销售额：
                <a-space :size="8">
                  <span class="bold">¥ {{ data.todayMoney }}万</span>
              ...
              <div class="inline-block">
                同比增长：
                <a-space :size="8">
                  <span class="bold">{{ data.pariPassu }}%</span>
                  <a-icon
                    :type="data.pariPassu ? 'caret-down' : 'caret-up'"
                    :class="data.pariPassu ? 'down' : 'up'"
                  />
                </a-space>
              </div>
            </div>
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-two" @click="sendTitle('访问量', 'visit')">
          <div class="card-title">
            <a-space :size="8">
              <svg-icon icon="visit" :size="20" />访问量
            </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-three" @click="sendTitle('加购数', 'shopCard')">
          <div class="card-title">
            <a-space :size="8">
              <svg-icon icon="shopCard" :size="20" />加购数
            </a-space>
          </div>
          <div class="all-count">
      ...
      <a-col :xs="12" :md="12" :sm="12" :lg="6">
        <div class="card-item card-item-four" @click="sendTitle('支付数', 'pay')">
          <div class="card-title">
            <a-space :size="8">
              <svg-icon icon="pay" :size="20" />支付笔数
            </a-space>
          </div>
          <div class="all-count">
